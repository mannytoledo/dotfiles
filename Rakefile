# This script is taken almost entirely from the fine folks at square
# https://github.com/square/maximum-awesome
#
# By far one of the best ways to get started with Vim they are good people :-)
#
...
task :default do
  ...
  unless File.exist?(File.expand_path('~/.vimrc.local'))
    cp File.expand_path('vim/vimrc.local.symlink'), File.expand_path('~/.vimrc.local'), :verbose => true
  end
